package com.dheerendrakumar.martialartsclub.model;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createDatabaseSQL = "create table " + MARTIAL_ARTS_TABLE + "( " + ID_KEY + " integer primary key autoincrement"
    ...
    public void modifyMartialArtObject(int martialArtID , String martialArtName , String martialArtPrice , String martialArtColor) {
        ...
        database.execSQL(modifySQLMartialArtCommand);
        database.close();
    ...
    public MartialArt returnMaritalArtObjectByID(int id) {

        SQLiteDatabase database = getWritableDatabase();
        String sqlQueryComand = "select * from " + MARTIAL_ARTS_TABLE +
                                " where " + ID_KEY + " = " + id;
        Cursor cursor = database.rawQuery(sqlQueryComand,null);
